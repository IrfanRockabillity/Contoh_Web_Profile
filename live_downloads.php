...
<table border="1" id="table">
	<tr>
		<td colspan="2">
		<?php
			include "cek_session_livedownloads.php";
	...
	<tr>
		<td id="content"><h3>Downloads</h3>
		<ul style="text-align:left">
			<li>Nothing Else Matters<br>
				<audio controls>
				<source src="Lagu/Metallica - Nothing Else Matters.mp3" type="audio/mp3">
				</audio>
			</li>
		</ul>
		</td>
