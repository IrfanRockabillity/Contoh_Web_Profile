	...
	<tr>
		...
		<? 
			...
			while ($result = mysql_fetch_array($query)) {
				...
				$isi = substr($isi_artikelnya,0,350);
		...
		<td id="sidebar">
				<h3>Metallica Fans Club</h3>
					...
					</a><a href="http://www.youtube.com/user/MetallicaTV" target="_blank"><img src="images/youtube.png" width="33" height="33" alt="Youtube" /></a>      
			</div>
		</td>
	</tr>
	<tr>
